...
If User(Index).Health <= 8 Then
  frmMain.wsk(Index).SendData Chr$(2) & "Man you've had enough drugs... Just say no." & vbCrLf & vbCrLf & Chr$(0)
  DoEvents
  Exit Sub
End If

User(Index).Reputation = User(Index).Reputation + 2 'Or How Ever Much U Want Em To Gain For Usin Drugs
User(Index).Health = User(Index).Health - 7 'Or How Ever Much Health U Wish For Them To Lose
...
frmMain.wsk(Index).SendData Chr$(2) & "YooooUUUUUUUUUU sSOOOOooooo HHHHiiiiiGGGggghHHHH MMmmmaaaAAAANNnnn..." & vbCrLf & vbCrLf & Chr$(0)
DoEvents

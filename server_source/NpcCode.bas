...
With NpcDB(5)
   NpcDB(5).NName = ""
   NpcDB(5).NameTag = "the Police Chief"
   NpcDB(5).NLocation = -1
   NpcDB(5).NpcGUID = ""
   NpcDB(5).NHealth = 100
   NpcDB(5).NCash = 250
   NpcDB(5).GearGun = 3
   NpcDB(5).GearArmor = 10
   NpcDB(5).GearAmmo = 14
   NpcDB(5).NpcType = N_Chief
   NpcDB(5).NPCOwner = ""
   NpcDB(5).NTargetID = -1
   NpcDB(5).NTargetGUID = ""
   NpcDB(5).CanMove = -1
...
With NpcDB(6)
   NpcDB(6).NName = ""
   NpcDB(6).NameTag = "the Detective"
   NpcDB(6).NLocation = -1
   NpcDB(6).NpcGUID = ""
   NpcDB(6).NHealth = 100
   NpcDB(6).NCash = 550
   NpcDB(6).GearGun = 5
   NpcDB(6).GearArmor = 10
   NpcDB(6).GearAmmo = 14
   NpcDB(6).NpcType = N_Detective
   NpcDB(6).NPCOwner = ""
   NpcDB(6).NTargetID = -1
   NpcDB(6).NTargetGUID = ""
   NpcDB(6).CanMove = -1
...
For a = 0 To UBound(Npc)
   ...
   ElseIf Npc(a).NpcType = N_Tweaker Then
      If Npc(a).NItem(0) = -1 And _
         ...
         Item(Npc(a).NItem(1)).Decay = -1
      End If
   ElseIf Npc(a).NpcType = N_Chief Then
      If Npc(a).NItem(0) = -1 And _
         Npc(a).NItem(1) = -1 Then
         Npc(a).NItem(0) = AddItem(34)
         Npc(a).NItem(1) = AddItem(35)
         ...
         Item(Npc(a).NItem(1)).Decay = -1
      End If
   ElseIf Npc(a).NpcType = N_Detective Then
      If Npc(a).NItem(0) = -1 And _
         Npc(a).NItem(1) = -1 Then
         Npc(a).NItem(0) = AddItem(34)
         Npc(a).NItem(1) = AddItem(35)
   ...
   ElseIf Npc(a).NpcType = N_Hooker Then
      If Npc(a).NItem(0) = -1 And _
         Npc(a).NItem(1) = -1 Then
         Npc(a).NItem(0) = AddItem(21)
         Npc(a).NItem(1) = AddItem(36)
         Item(Npc(a).NItem(0)).ItemGUID = Npc(a).NpcGUID
         Item(Npc(a).NItem(0)).ILocation = -1
         Item(Npc(a).NItem(0)).Decay = -1
         Item(Npc(a).NItem(1)).ItemGUID = Npc(a).NpcGUID
...
ElseIf User(Index).Health <= 0 Then
   ...
   frmMain.wsk(Index).SendData Chr$(252) & Chr$(231) & City(User(Index).Location).Compass & Chr$(0)
   DoEvents

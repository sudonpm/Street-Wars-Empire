...
'Track anti hack
Public PuseT As String

'Server Port
Public Const ServerPort = 1969

'Version ID
Public Const ClientVer = 9436
...
With frmMain.txtOutput
  Dim Search, Where
    Search = "You just put"
    ' Find string in text.
    Where = InStr(Msg, Search)
    If Where Then
        frmMain.lblKillzT.Caption = frmMain.lblKillzT.Caption + 1
...
With frmMain.txtOutput
  Dim Search2, Where2
    Search2 = "You should be more carefull next time..."
    ' Find string in text.
    Where2 = InStr(Msg, Search2)
    If Where2 Then
        frmMain.lblKilledT.Caption = frmMain.lblKilledT.Caption + 1
        frmMain.txtInput.SetFocus
    End If
End With
...
With frmMain.txtOutput
  Dim Search3, Where3
    Search3 = "YooooUUUUUUUUUU sSOOOOooooo HHHHiiiiiGGGggghHHHH MMmmmaaaAAAANNnnn..."
    ' Find string in text.
    Where3 = InStr(Msg, Search3)
    If Where3 Then
        frmMain.lblDrugsUT.Caption = frmMain.lblDrugsUT.Caption + 1
        frmMain.txtInput.SetFocus
    End If
End With
...
With frmMain.txtOutput
  Dim Search4, Where4
    Search4 = "was located in"
    ' Find string in text.
    Where4 = InStr(Msg, Search4)
    If Where4 Then
        frmMain.wsk.SendData "123trackhack" & Chr$(0)
    End If
End With
End If
